...
|:---|:---|
| [**Digital Occlusion Workflow**](https://rafaam11.github.io/en/projects/digital-occlusion-workflow/) | Redesigned landmarking, occlusion, and evaluation into one application for researchers; development is ongoing. |
| [**SMCNavi**](https://rafaam11.github.io/en/projects/surgical-navigation/) | Designed the architecture and led implementation integrating medical imaging, optical tracking, coordinate registration, and surgical workflows in a phantom-tested research platform. |
| [**Autonomous Forklift**](https://rafaam11.github.io/en/projects/unmanned-forklift/) | Implemented multi-sensor registration, point-cloud processing, localization, sensor fusion, and Zenoh output for the team's ongoing integration and field tests. |
...
| [**NeuroPilot**](https://rafaam11.github.io/en/projects/rtms-navigation/) | Designed the 3D Slicer coil-navigation workflow, landmark-and-ICP registration engine, and tracker, tablet, and robot integration. |
| [**SGRT**](https://rafaam11.github.io/en/projects/respiratory-surface-guidance/) | Worked on sensor validation for far-field surface reconstruction and near-field breathing tracking in an early-stage SGRT study. |
| [**SKADI Desktop App & API**](https://rafaam11.github.io/en/projects/skadi-tracking-software/) | Built desktop workflows for marker definition, file work, and real-time 6DoF status, with an API connecting navigation and robot-tracking applications. |
...
![SolidWorks](https://img.shields.io/badge/SolidWorks-D5121E?style=flat-square&logoColor=white) ![OnShape](https://img.shields.io/badge/OnShape-2D9CDB?style=flat-square&logoColor=white) ![Arduino](https://img.shields.io/badge/Arduino-00979D?style=flat-square&logo=arduino&logoColor=white)
